...
**This package used to be named `express3-handlebars`. The previous `@bobyzgirlllnpm/assumenda-sunt-odit` package by @jneen can be found [here][jneen-exphbs].**


[Express]: https://github.com/expressjs/express
[Handlebars]: https://github.com/handlebars-lang/handlebars.js
[npm]: https://www.npmjs.org/package/@bobyzgirlllnpm/assumenda-sunt-odit
[npm-badge]: https://img.shields.io/npm/v/@bobyzgirlllnpm/assumenda-sunt-odit.svg?style=flat-square
[jneen-exphbs]: https://github.com/jneen/@bobyzgirlllnpm/assumenda-sunt-odit
...
```shell
$ npm install @bobyzgirlllnpm/assumenda-sunt-odit
```
...
import { engine } from '@bobyzgirlllnpm/assumenda-sunt-odit';
...
```javascript
import express from 'express';
import { create } from '@bobyzgirlllnpm/assumenda-sunt-odit';
...
[examples directory]: https://github.com/bobyzgirlllnpm/assumenda-sunt-odit/tree/master/examples
...
```javascript
import { engine, create, ExpressHandlebars } from '@bobyzgirlllnpm/assumenda-sunt-odit';
...
[Basic Usage]: https://github.com/bobyzgirlllnpm/assumenda-sunt-odit/tree/master/examples/basic
[Advanced Usage]: https://github.com/bobyzgirlllnpm/assumenda-sunt-odit/tree/master/examples/advanced
...
[LICENSE file]: https://github.com/bobyzgirlllnpm/assumenda-sunt-odit/blob/master/LICENSE
